...
class OrderForm:
    ...
    def upgrade_needed_window(self, message):
        with dpg.window(tag="Upgrade Needed"):
            ...
            dpg.add_button(label="Complete Upgrade", callback=self.download_callback, parent="Upgrade Needed")
    ...
    def download_callback(self):
        with dpg.window(tag="Downloading"):
            dpg.add_text("Download in progress. Please do not close out app until download completes.", tag="Download in Progress", parent="Downloading")
            dpg.set_primary_window("Downloading", True)
        dpg.delete_item("Upgrade Needed")
        ...
        with open(os.path.join(os.path.expanduser("~"), "Downloads", 'pdf_annotation_app.zip'), 'wb') as f:
        ...
        dpg.delete_item("Download in Progress")
        dpg.add_text("Download complete. Close out app. Right click on app shortcut and click on properties. \nDetermine the correct filepath for the app folder, 'pdf_annotation_app'. Go to Downloads folder on \ncomputer and move folder to that location, overwriting the previous app. Re-open the app to use the latest version.", parent="Downloading")
        dpg.add_button(label="Exit", callback=self.exit_callback, parent="Downloading")
    ...
    def cover_parent_sheet_quantity_callback(self, sender, data):
        self.cover_parent_sheet_quantity = data
    ...
    def text_parent_sheet_quantity_callback(self, sender, data):
        self.text_parent_sheet_quantity = data
